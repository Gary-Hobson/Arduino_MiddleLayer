...
#define CHIP_PIN_LIST \
	...
	PIN(B,8), PIN(B,9), PIN(B,10), 	PIN(B,11), 	PIN(B,12), 	PIN(B,13), 	PIN(B,14), 	PIN(B,15),  \
	PIN(C,0), PIN(C,1), PIN(C,2), 	PIN(C,3), 	PIN(C,4), 	PIN(C,5), 	PIN(C,6), 	PIN(C,7),   \
	PIN(C,8), PIN(C,9), PIN(C,10), 	PIN(C,11), 	PIN(C,12), 	PIN(C,13), 	PIN(C,14), 	PIN(C,15),  \
	PIN(D,0), PIN(D,1), PIN(D,2), 	PIN(D,3), 	PIN(D,4), 	PIN(D,5), 	PIN(D,6), 	PIN(D,7),   \
	PIN(D,8), PIN(D,9), PIN(D,10), 	PIN(D,11), 	PIN(D,12), 	PIN(D,13), 	PIN(D,14), 	PIN(D,15),  \
	PIN(E,0), PIN(E,1), PIN(E,2), 	PIN(E,3), 	PIN(E,4), 	PIN(E,5), 	PIN(E,6), 	PIN(E,7),   \
	PIN(E,8), PIN(E,9), PIN(E,10), 	PIN(E,11), 	PIN(E,12), 	PIN(E,13), 	PIN(E,14), 	PIN(E,15),  \
	PIN(F,0), PIN(F,1), PIN(F,2), 	PIN(F,3), 	PIN(F,4), 	PIN(F,5), 	PIN(F,6), 	PIN(F,7),   \
	PIN(F,8), PIN(F,9), PIN(F,10), 	PIN(F,11), 	PIN(F,12), 	PIN(F,13), 	PIN(F,14), 	PIN(F,15),  \
